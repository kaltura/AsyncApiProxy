...
KalturaLogger = {
	...
	access: function(request, response){
		...
		request.workerId = process.env['WORKER_ID'];
		...
		request.log = function(msg){
			KalturaLogger.log('Worker [' + request.workerId + '] Request [' + request.sessionId + '] ' + msg, getStack());
		};
		request.dir = function(object){
			KalturaLogger.dir(object, getStack(), 'Worker [' + request.workerId + '] Request [' + request.sessionId + '] ');
		};
		request.error = function(msg){
			KalturaLogger.error('Worker [' + request.workerId + '] Request [' + request.sessionId + '] ' + msg, getStack());
		};
		request.debug = function(msg){
			KalturaLogger.debug('Worker [' + request.workerId + '] Request [' + request.sessionId + '] ' + msg, getStack());
		};
