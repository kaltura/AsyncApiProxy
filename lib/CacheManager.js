...
class CacheManager {
    ...
    cacheCall(request, cacheHandler) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            let sendBeforeCaching = cacheHandler.requestHandler.sendBeforeCaching;
